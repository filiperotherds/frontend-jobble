    ...
    <div className="bg-neutral-900 dark min-h-svh flex flex-row">
      <div className="dark flex flex-col items-center flex-1 shrink-0 p-8 border-r shadow-lg bg-studio border-default">
        <div className="w-full h-fullflex justify-center gap-2 md:justify-start">
          <Link href="/">
            <img src={logo.src} alt="Jobble" className="w-24" />
          </Link>
        </div>
      ...
      <aside className="bg-neutral-950 flex-col items-center justify-center flex-1 hidden basis-1/4 lg:flex">
        <div className="relative flex flex-col gap-6">
          <div className="absolute select-none -top-12 -left-11">
            <span className="text-[160px] leading-none text-muted-foreground/30">
              “
            </span>
          </div>
          <span className="text-primary z-10 max-w-lg text-xl">
            Uma ferramenta que ajuda de verdade. Acompanhar as métricas e ver o
            número de cliques que meu WhatsApp tá recebendo é muito bom. Fora
            que fazer o orçamento por la economiza um bom tempo, pra quem vive
            na correria, é uma mão na roda.
          </span>
          <a
            href="https://chaveiropanorama.jobble.com.br"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-4"
          >
            <img
              src="https://osqinylytyyjfppindqy.supabase.co/storage/v1/object/public/jobble-public/chaveiro-panorama.jpg"
